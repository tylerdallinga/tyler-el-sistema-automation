...
module.exports = {
    ...
    topNavigation: (data, browser) => {
        browser
            .click(data.topNav1)
            .waitForElementPresent(data.assert1, 2000)
            .assert.elementPresent(data.assert1)
            .back()
            .waitForElementPresent(data.assertStart, 2000)
            .assert.elementPresent(data.assertStart)
            .click(data.topNav2)
            .waitForElementPresent(data.assert2, 2000)
            .assert.elementPresent(data.assert2)
            .back()
            .waitForElementPresent(data.assertStart, 2000)
            .assert.elementPresent(data.assertStart)
            .click(data.topNav3)
            .waitForElementPresent(data.assert3, 2000)
            .assert.elementPresent(data.assert3)
            .back()
            .waitForElementPresent(data.assertStart, 2000)
            .assert.elementPresent(data.assertStart)
            .click(data.topNav4)
            .waitForElementPresent(data.assert4, 2000)
            .assert.elementPresent(data.assert4)
            .back()
            .waitForElementPresent(data.assertStart, 2000)
            .assert.elementPresent(data.assertStart)
            .click(data.topNav5)
            .waitForElementPresent(data.assert5, 2000)
            .assert.elementPresent(data.assert5)
            .back()
            .waitForElementPresent(data.assertStart, 2000)
            .assert.elementPresent(data.assertStart)
    },
    ...
    bottomNavigation: (data, browser) => {
        ...
        browser
            ...
            .waitForElementPresent(data.assert6, 2000)
            .assert.elementPresent(data.assert6)
